...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/cueshut/saves/main/octohook%20ui%20lib"))({cheatname = "example", gamename = "example game"})
library:init()

local menu = library.NewWindow({title = "Masterclass", size = UDim2.new(0, 500, 0.7, 20.7)})
